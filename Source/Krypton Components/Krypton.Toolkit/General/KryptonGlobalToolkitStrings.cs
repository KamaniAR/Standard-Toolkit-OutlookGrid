...
public class KryptonGlobalToolkitStrings : GlobalId
{
    ...
    /// <summary>Gets the krypton outlook grid strings.</summary>
    /// <value>The krypton outlook grid strings.</value>
    [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
    ...
    /// <summary>Resets the krypton outlook grid strings.</summary>
    public void ResetOutlookGridStrings() => KryptonOutlookGridStrings.Reset();
